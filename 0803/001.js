//isNaN() 함수는 어떤 값이 NaN인지 판별함
//isNaN() 함수는 어떤 값이 숫자가 아닌지 판별함 
//숫자로 판별되는 것들은 false를 반환하고 숫자로 판별되지 않는 것들은 true로 반환함 
...
isNaN(value[1]) //p, false
isNaN(value[2]) //p, true
...
//안배운 것을 써보자면 
"p2o418gj2".split("").filter(v => !isNaN(v))
